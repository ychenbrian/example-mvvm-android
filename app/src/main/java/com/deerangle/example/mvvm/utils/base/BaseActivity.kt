...
import com.deerangle.example.mvvm.BR
...
abstract class BaseActivity<DB : ViewDataBinding, VM : ViewModel>(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Call the setupViews function to perform additional view setup
        setupView()
    }

    // This function can be overridden in concrete activities
